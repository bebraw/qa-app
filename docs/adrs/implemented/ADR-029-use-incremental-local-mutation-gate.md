...
ADR-022 added Stryker mutation testing to the full quality gate and CI workflow. That improved assertion-strength checks, but full local mutation runs slow down regular development as the source and test surface grows.
